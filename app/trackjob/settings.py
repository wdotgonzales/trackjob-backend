"""
Django settings for trackjob project.
...
WSGI_APPLICATION = 'trackjob.wsgi.application'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=1),  # timedelta(seconds=30) Set to 30 seconds for testing
